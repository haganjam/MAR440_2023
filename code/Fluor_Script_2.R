...
mix_sal <- c(31.14992, 30.93664, 31.45, 30.52411, 30.52692)
...
write.table(data_good, file = "avg_val_data.csv",
            sep = "\t", row.names = F)

#multivariate statistics of the dataset